...
3.To implement the two-stage fine-tuning, please adjust the following two parameters in main.py: lr_spatialand lr_temporal. These parameters control the spatial and temporal modules, respectively.
